...
const rhfSwitchPropsRows: GuidePropsTableRow[] = [
  {
    name: "name",
  ...
  },
  {
    ...
    defaultValue: "false",
    description:
      "useController와 실제 Switch에 동시에 반영되어 필드 업데이트와 상호작용을 막습니다.",
  },
  {
    name: "readOnly",
    typeLabel: "boolean",
    defaultValue: "false",
    description:
      "Switch로 전달되어 현재 값을 유지한 채 변경만 막습니다.",
  },
  {
    name: "isError",
    typeLabel: "boolean",
  ...
  },
  {
    ...
    typeLabel: "Switch inherited props",
    defaultValue: "inherited",
    description:
      "RHF가 직접 관리하지 않는 Switch props는 그대로 전달할 수 있습니다.",
  },
];

export default function RHFSwitchPropsTableSection() {
  const rhfSwitchTypeCode = `${RHF_COMPONENT_PROPS_CODE}
...
>;`;
  ...
  return (
    <GuideSection
      label="Props Table"
      title="RHFSwitch props 한눈에 보기"
      description="RHFSwitch에서 사용하는 RHF 제어 props와 Switch 상속 props를 표로 정리했습니다."
    >
      <GuidePropsTable
        rows={rhfSwitchPropsRows}
        note={
          <>
            <span>
              <code>RHFSwitchProps</code>는{" "}
              <code>RHFComponentProps&lt;TFormValues, TFieldName, SwitchProps, RHFCheckedInputManagedProps&gt;</code>
              ...
              RHF가 관리하고, 나머지 Switch props만 직접 전달하는 패턴입니다.
            </span>
            <div className="guidePropsTable__noteActions">
              <GuideTypeTooltip
                ...
                description="Switch, Checkbox 같은 RHF checked-input wrapper가 공통으로 사용하는 타입 정의입니다."
                code={rhfSwitchTypeCode}
              />
            </div>
          </>
        }
